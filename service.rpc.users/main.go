...
import (
	...
	"github.com/yunuseskisan/touch/service.rpc.users/internal/db/migrations"
	"github.com/yunuseskisan/touch/service.rpc.users/internal/handler"
...
func main() {
	...
	mux := grpc.NewServer()
	usersproto.RegisterUsersServiceServer(mux, handler.New(conn))
